...
const addParticipant = (event, person) => {
  ...
  newParagraph.textContent = `🎟️ ${person.name} from ${person.hometown} has RSVP'd`;
  const participantList = document.querySelector(".rsvp-participants");
  participantList.appendChild(newParagraph);
}
...
const toggleModal = (person) => {
    ...
    modalContent.textContent = `Thank you ${person.name} for RSVPing to PawnFest! Additional information will be sent to your E-mail.`
